...
public abstract class AbstractUserApplicationService<S extends MongoRepository<T, ObjectId>, T extends AbstractUserApplicationEntity> {

    protected final S repository;

    protected final String entityName;

    public AbstractUserApplicationService(S repository, String entityName) {
